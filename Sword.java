...
public class Sword extends Item implements TargetsCreature {
	...
	public Sword() {//This is the constructor that runs when a new instance of the Fireball class is created.
	...
	public void strikeSword(Player p) {//We are sending it the information of who is casting it, call this "p" as a variable.
